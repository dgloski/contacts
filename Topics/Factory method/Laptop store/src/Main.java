...
class LaptopStore extends LaptopFactory {
    ...
    Laptop createLaptop(String type) {
        switch (type) {
            case "13 inch":
                return new Laptop13();/* write your code here */
            case "15 inch":
                return new Laptop15(); /* write your code here */
            case "17 inch":
                return new Laptop17();/* write your code here */
            default:
                return null;
        }
    }
...
class Laptop13 extends Laptop {
    Laptop13() {
        super("13 inch Laptop");
    }
}

class Laptop15 extends Laptop {
    Laptop15() {
        super("15 inch Laptop");
    }
}

class Laptop17 extends Laptop {
    Laptop17() {
        super("17 inch Laptop");
    }
}
